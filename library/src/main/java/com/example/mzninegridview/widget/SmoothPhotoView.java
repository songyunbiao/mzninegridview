...
/*
    ...
    private void initTransform() {
        ...
        if (mBitmap == null) {
//            mBitmap = ((BitmapDrawable) getDrawable()).getBitmap();//TODO
    ...
    public void setOnTransformListener(SmoothPhotoView.onTransformListener onTransformListener) {
